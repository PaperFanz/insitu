...
void ModeContainer::tile(void) { container->tileSubWindows(); }

void ModeContainer::cascade(void) { container->cascadeSubWindows(); }

ModeContainer::~ModeContainer(void) { delete nh; }
...
const ros::NodeHandle &ModeContainer::getNodeHandle(void) { return *nh; }
